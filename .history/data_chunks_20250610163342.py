...
# Settings
CHUNK_SIZE = 300  # approx tokens
CHUNK_OVERLAP = 50  # overlap between chunks
OUTPUT_FILE = "all_chunks.jsonl"

# Load data
tds_df = pd.read_csv("cleaned_tds_content.csv")         # should have 'title' and 'content'
disc_df = pd.read_csv("cleaned_discourse_posts.csv")    # should have 'topic_title' and 'content'

# Merge columns for uniform chunking
